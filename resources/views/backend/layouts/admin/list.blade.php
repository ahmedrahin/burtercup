    ...
    <div class="wg-box">
        ...
        <div class="wg-table table-all-user mt-4">
            <table id="table" class="w-full">
                <thead>
                    <tr>
                        <th class="text-left body-title">Admin</th>
                        <th class="text-center body-title">Email</th>
                        <th class="text-center body-title">Last Login</th>
    ...
    <script>
        let table = $('#table').DataTable({
            ...
            columns: [
                ...
                { data: 'email', name: 'email', className: 'text-center', searchable: true, orderable: false },
                { data: 'last_login_at', name: 'last_login_at', orderable: false, searchable: false, className: 'text-center' },
