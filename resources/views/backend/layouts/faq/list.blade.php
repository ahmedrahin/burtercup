            ...
            <table id="table" class="w-full">
                <thead>
                    <tr>
                        ...
                        <th class="text-left body-title" style="width: 20%;">Question</th>
                        <th class="text-left body-title" style="width: 10%;">Type</th>
                        <th class="text-left body-title" style="width: 50%;">Answer</th>
    ...
    <script>
        let table = $('#table').DataTable({
            ...
            columns: [
                ...
                { data: 'answer', name: 'answer', orderable: false, searchable: true },
        ...
        $(document).on('click', '.item.trash', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var deleteUrl = "{{ route('faq.destroy', ':id') }}";
