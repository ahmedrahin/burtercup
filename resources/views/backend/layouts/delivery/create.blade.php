            ...
            <div class="wg-box">
                ...
                <div class="right flex-grow">
                    ...
                    <fieldset class="name mb-14">
                        ...
                        <input class="flex-grow" type="text" placeholder="Business Days" name="day" >
                        <div class="error text-danger"></div>
                    </fieldset>

                    <fieldset class="name mb-14">
                        <div class="body-title mb-10"> Price</div>
                        <input class="flex-grow" type="text" placeholder="Price" name="price" >
                        <div class="error text-danger"></div>
                    </fieldset>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#addform').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('delivery-option.store') }}",
                    method: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
