...
@section('title', 'All Versus Categories')
...
<div class="main-content-wrap">
    ...
    <div class="wg-box">
        <div class="flex items-center justify-between gap10 flex-wrap">
            ...
            <a class="tf-button style-1 w208" href="{{ route('game-category.create') }}">
            ...
            <table id="table" class="w-full">
                <thead>
                    <tr>
                        ...
                        <th class="text-left body-title" style="width: 20%;">Free</th>
                        <th class="text-left body-title" style="width: 20%;">Premium</th>
                        <th class="text-left body-title" style="width: 20%;">Platinum</th>
...
@push('scripts')
    ...
    <script>
        let table = $('#table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('game-category.index') }}",
            pageLength: 10,
            ...
            columns: [
                ...
                { data: 'free', name: 'free', orderable: false, searchable: false, className: 'text-center' },
                { data: 'premium', name: 'premium', orderable: false, searchable: false, className: 'text-center' },
                { data: 'platinum', name: 'platinum', orderable: false, searchable: false, className: 'text-center' },
