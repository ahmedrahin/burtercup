    ...
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <div class="flex items-center justify-between gap10 flex-wrap">
                ...
                <a class="tf-button style-1 w208" href="{{ route('game.create') }}">
                ...
                <table id="table" class="w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="text-left body-title" style="width: 20%;">Game</th>
                            <th class="text-left body-title" style="width: 20%;">Category</th>
                            <th class="text-left body-title" style="width: 20%;">Total Options</th>
    ...
    <script>
        let table = $('#table').DataTable({
            ...
            columns: [
                ...
                { data: 'name', name: 'name', searchable: true, orderable: true, className: 'text-center' },
                { data: 'category', name: 'category', searchable: true, orderable: true, className: 'text-center' },
                { data: 'option', name: 'option', searchable: true, orderable: true, className: 'text-center' },
        ...
        $(document).on('click', '.item.trash', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var deleteUrl = "{{ route('game.destroy', ':id') }}";
