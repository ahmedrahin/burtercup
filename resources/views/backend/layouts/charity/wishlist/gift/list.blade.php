...
@section('title', 'All Wishlist Items')
...
<div class="main-content-wrap">
    ...
    <div class="wg-box">
        <div class="flex items-center justify-between gap10 flex-wrap">
            ...
            <a class="tf-button style-1 w208" href="{{ route('wishlist-list.create') }}">
            ...
            <table id="table" class="w-full">
                <thead>
                    <tr>
                        ...
                        <th class="text-center body-title" style="width: 30%;">Wishlist Item</th>
...
@push('scripts')
    ...
    <script>
        let table = $('#table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('wishlist-list.index') }}",
            pageLength: 10,
