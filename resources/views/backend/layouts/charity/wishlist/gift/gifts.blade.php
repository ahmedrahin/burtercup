...
@section('title', 'Gifts Information')
    ...
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <div class="flex items-center justify-between gap10 flex-wrap">
                ...
                <div>
                    <select name="approve_status" id="statusFilter">
                ...
                <table id="table" class="w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="text-left body-title" style="width: 20%;">User</th>
                            <th class="text-center body-title" style="width: 30%;">Wishlist</th>
                            <th class="text-center body-title" style="width: 15%;">Date</th>
                            <th class="text-center body-title" style="width: 15%;">Approve</th>
    ...
    <script>
        let table = $('#table').DataTable({
            ...
            drawCallback: function(settings) {
                ...
                pagination +=
                    `<li><a class="prev ${info.page === 0 ? 'disabled' : ''}"><i class="icon-chevron-left"></i></a></li>`;
                for (let i = 0; i < info.pages; i++) {
                    let activeClass = (i === info.page) ? 'active' : '';
                    pagination += `<li><a class="${activeClass}" data-page="${i}">${i + 1}</a></li>`;
                }
                pagination +=
                    `<li><a class="next ${info.page === info.pages - 1 ? 'disabled' : ''}"><i class="icon-chevron-right"></i></a></li>`;
        ...
        $(document).on('click', '.item.trash', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var deleteUrl = "{{ route('gift.delete') }}";
                    ...
                    $.ajax({
                        ...
                        error: function(error) {
                            Swal.fire('Error!', 'There was an error deleting the category.',
                                'error');
                        }
                    });
                }
