            ...
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li>
                    <a href="{{ route('wishlist.index') }}">
                        <div class="text-tiny">Wishlist</div>
                    </a>
                </li>
                <li>
                    <i class="icon-chevron-right"></i>
         ...
         <form class="form-add-new-user form-style-2" id="addform" enctype="multipart/form-data">
            <div class="wg-box">
                <div class="right flex-grow">
                    ...
                    <fieldset class="name mb-14">
                        <div class="body-title mb-10">Recive Coin</div>
                        <input class="flex-grow" type="number" placeholder="Coin" name="coin" value="{{ $data->coin }}">
                        <div class="error text-danger"></div>
                    </fieldset>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#addform').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('wishlist.update', $data->id) }}",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
