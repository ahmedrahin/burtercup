...
<div class="main-content-wrap">
    ...
    <div class="wg-box">
        <div class="flex items-center justify-between gap10 flex-wrap">
            ...
            <a class="tf-button style-1 w208" href="{{ route('wishlist.create') }}">
            ...
            <table id="table" class="w-full">
                <thead>
                    <tr>
                        ...
                        <th class="text-center body-title" style="width: 30%;">Category</th>
        ...
        $(document).on('click', '.item.trash', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var deleteUrl = "{{ route('wishlist.destroy', ':id') }}";
