...
@section('title', 'All Wishlist Categories')
...
<div class="main-content-wrap">
    ...
    <div class="wg-box">
        <div class="flex items-center justify-between gap10 flex-wrap">
            ...
            <a class="tf-button style-1 w208" href="{{ route('wishlist-category.create') }}">
        ...
        <div class="wg-table table-all-user mt-4">
            <table id="table" class="w-full">
                <thead>
                    <tr>
                        <th class="text-left body-title" style="width: 5%;">Sl.</th>
...
@push('scripts')
    ...
    <script>
        let table = $('#table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('wishlist-category.index') }}",
            pageLength: 10,
    ...
    <script>
        $(document).on('change', '.status-switch', function() {
            ...
            $.ajax({
                url: '{{ route("wishlist-category.status") }}',
                method: 'POST',
                data: {
                    id: id,
                    status: status,
        ...
        $(document).on('click', '.item.trash', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var deleteUrl = "{{ route('wishlist-category.destroy', ':id') }}";
