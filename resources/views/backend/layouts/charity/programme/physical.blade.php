...
@section('title', 'Physical Programmes')
    ...
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <div class="flex items-center justify-between gap10 flex-wrap">
                ...
                <a class="tf-button style-1 w208" href="{{ route('programmes.create') }}">
                ...
                <table id="table" class="w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="text-left body-title" style="width: 10%;">Total Assign</th>
...
@push('scripts')
    ...
    <script>
        let table = $('#table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('programmes.physical') }}",
            pageLength: 10,
            ...
            columns: [
                ...
                { data: 'assign', name: 'assign', searchable: false, orderable: false, className: 'text-center' },
        ...
        $(document).on('click', '.item.trash', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var deleteUrl = "{{ route('programmes.destroy', ':id') }}";
